...
This project requires environment variables to be set. Create a `.env` file in the root directory with the following variables:
...
1. Sign up for a free account at [imgbb.com](https://imgbb.com/)
...
```env
VITE_IMGBB_API_KEY=8dd03d3180f7a3f08edb89b154b2c109
```
